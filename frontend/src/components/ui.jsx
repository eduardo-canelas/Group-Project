...
export function Alert({ children, tone = 'error' }) {
  const toneMap = {
    error: 'border-rose-500/25 bg-rose-500/10 text-rose-100 dark:text-rose-100',
    success: 'border-emerald-500/25 bg-emerald-500/10 text-emerald-100 dark:text-emerald-100',
    info: 'border-sky-500/25 bg-sky-500/10 text-sky-100 dark:text-sky-100',
  };
